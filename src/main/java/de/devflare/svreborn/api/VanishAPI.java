...
package de.devflare.svreborn.api;
...
public class VanishAPI {
    ...
    private static SuperVanishReborn PLUGIN;
     ...
     * <p/>
     * Deprecated: Will cause minor lag if mysql is enabled, use asynchronously or
     * sparingly
     *
    ...
    public static SuperVanishReborn getPlugin() {
        return PLUGIN;
    }

    public static void setPlugin(SuperVanishReborn plugin) {
