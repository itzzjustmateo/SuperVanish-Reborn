...
public enum CommandAction {
    VANISH_SELF(
        ...
        @Override
        public boolean checkPermission(CommandSender sender, SuperVanishReborn plugin) {
    ...
    /**
     * Use {@link #checkPermission(CommandSender, SuperVanishReborn)} to check whether a {@link CommandSender} has
    ...
    static List<String> getAvailableFirstArguments(CommandSender sender, SuperVanishReborn plugin) {
        Validation.checkNotNull(plugin, "plugin cannot be null");
    ...
    public static boolean hasAnyCmdPermission(CommandSender sender, SuperVanishReborn plugin) {
