...
public class ServerListPacketListener extends PacketAdapter {
    ...
    public ServerListPacketListener(SuperVanishReborn plugin) {
     ...
     */
    public ServerListPacketListener(SuperVanishReborn plugin, boolean use_legacy) {
        //noinspection deprecation
        super(plugin, ListenerPriority.NORMAL, PacketType.Status.Server.OUT_SERVER_INFO);
        this.plugin = plugin;
    }

    public static void register(SuperVanishReborn plugin) {
    ...
    public static boolean isEnabled(SuperVanishReborn plugin) {
