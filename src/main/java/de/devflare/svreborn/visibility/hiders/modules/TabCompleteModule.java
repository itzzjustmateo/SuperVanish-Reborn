...
package de.devflare.svreborn.visibility.hiders.modules;
...
import de.devflare.svreborn.visibility.hiders.PlayerHider;
...
public class TabCompleteModule extends PacketAdapter {
    ...
    public TabCompleteModule(SuperVanishReborn plugin, PlayerHider hider) {
        super(plugin, ListenerPriority.HIGH, PacketType.Play.Server.TAB_COMPLETE);
        this.plugin = plugin;
        this.hider = hider;
    }

    public static void register(SuperVanishReborn plugin, PlayerHider hider) {
