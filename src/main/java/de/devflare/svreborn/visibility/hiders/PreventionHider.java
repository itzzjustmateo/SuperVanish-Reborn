...
package de.devflare.svreborn.visibility.hiders;

import org.bukkit.entity.Player;

import de.devflare.svreborn.SuperVanishReborn;
import de.devflare.svreborn.utils.BukkitPlayerHidingUtil;
import de.devflare.svreborn.visibility.hiders.modules.PlayerInfoModule;
import de.devflare.svreborn.visibility.hiders.modules.TabCompleteModule;

public class PreventionHider extends PlayerHider implements Runnable {

    private int taskId;

    public PreventionHider(SuperVanishReborn plugin) {
        super(plugin);
